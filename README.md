...
| `rust/src/studio/` | In-house harness, eight migrated seat assignments including Editor and Investigator, shared form, and generation contracts. |
| `rust/src/application/` | Explicit retrieval, routing, publication, and work adapters for migrated seats. |
| `rust/src/junctions/` | Graph and its transitional adapters; remove after its migration. |
