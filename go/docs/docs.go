...
const docTemplate = `{
            ...
            "get": {
                ...
                "responses": {
                    ...
                    "400": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/github_com_albapepper_scoracle-data_go_internal_api_respond.ErrorResponse"
                        }
                    },
                    "404": {
    ...
    "definitions": {
        "github_com_albapepper_scoracle-data_go_internal_api_respond.ErrorResponse": {
            "type": "object",
            "properties": {
                "error": {
                    "type": "object",
