...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v1/{sport}/weeks": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "Limit to one season",
                        "name": "season",
                        "in": "query"
                    }
                ],
        ...
        "/{sport}/leaderboard/momentum": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Omit for biggest movers both ways; up = risers only, down = fallers only",
                        "name": "direction",
                        "in": "query"
                    },
                    {
        ...
        "/{sport}/team/{id}/articulator/{kind}": {
            "get": {
        ...
        "/{sport}/{entityType}/{id}/headlines": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "Week of the year, 1-53, Jan-1 anchored (default: current)",
                        "name": "week",
                        "in": "query"
                    }
                ],
