...
func TestRouteOwnershipSplit(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "team articulator slice route registered", path: "/api/v1/nba/team/1/articulator/p1", wantStatus: http.StatusServiceUnavailable},
		{name: "unknown articulator slice is not routed", path: "/api/v1/nba/team/1/articulator/p9", wantStatus: http.StatusNotFound},
		{name: "player articulator slice route registered", path: "/api/v1/nba/player/1/articulator/p1", wantStatus: http.StatusServiceUnavailable},
