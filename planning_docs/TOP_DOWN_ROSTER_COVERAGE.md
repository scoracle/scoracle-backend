# Top-Down Roster Coverage + Enhanced Leaderboard Scopes

**Plan date:** 2026-06-21
**Baseline branch:** `main`
**Baseline commit:** `9e2b7fbb55a1f66374185c0429f3115f4b05c319`
...
**Status:** PLAN ONLY — not yet implemented. To be picked up in a separate session.
