...
fn scenarios() -> Vec<Scenario> {
    vec![
        Scenario {
            ...
            rating: rating("Shot creation", 83, "overall scores and the top skill trending up over recent games",
        ...
        Scenario {
            ...
            rating: rating("Third-down separation", 79, "recent overall marks are choppy with no clear sustained move",
        ...
        Scenario {
            ...
            rating: rating("High press recoveries", 88, "overall scores and the top skill trending up over recent games",
        ...
        Scenario {
            ...
            rating: rating("Transition finishing", 74, "two recent games show a better overall mark, but the sample is thin",
        ...
        Scenario {
            ...
            rating: rating("Chance suppression", 81, "overall defensive scores and the top skill trending down over recent matches",
        ...
        Scenario {
            ...
            rating: rating("Rim protection", 86, "overall scores and the top skill steady over recent games",
        ...
        Scenario {
            ...
            rating: rating("Progressive carries", 77, "overall scores and the top skill flat over recent matches",
        ...
        Scenario {
            ...
            rating: rating("Chance creation", 72, "overall scores and the top skill trending down over recent matches",
        ...
        Scenario {
            ...
            rating: rating("Shot creation", 68, "overall scores and the top skill trending up over recent games",
        ...
        Scenario {
            ...
            rating: rating("Pressing intensity", 61, "overall scores and the top skill trending down over recent matches",
