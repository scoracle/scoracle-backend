...
use crate::studio::scout::{RatingDatapoint, RatingProfile, RatingTrajectory};
...
pub async fn load_rating_trajectory(
    ...
    let window_size = crate::studio::scout::trajectory_window_size(events_played);
    if window_size == 0 {
        return Ok(crate::studio::scout::rating_trajectory_from_events(
            events_played,
            Vec::new(),
        ));
    }
    ...
    Ok(crate::studio::scout::rating_trajectory_from_events(
        events_played,
        ratings,
    ))
}
