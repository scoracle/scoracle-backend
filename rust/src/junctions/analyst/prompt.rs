...
HEADLINE: <the HOOK — one sentence, twelve words or fewer, written to make a fan tap the card for the full read. The entity's name inside a claim from your READ, the way the worked examples do it. Never a "Label: description" construction — no colon at all.>
