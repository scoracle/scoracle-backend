...
THE READING. Where this entity's arc stands now, and what would confirm or turn it — ONE claim, told whole: state where the arc stands, ground it in what the cards carry, close on what would confirm or turn it. This prints on a card: two to four sentences, and two is a complete reading. When your peers disagree, name the tension in THIS spread; a quiet, steady spread deserves a calm reading and drama the cards do not hold is never manufactured.
...
THE CARD IS A TAROT CARD. Everything you write has to fit on its face: a HEADLINE the seeker sees first, and a reading they turn it over for. That shape is the format — nothing here runs to a page.

HEADLINE: the HOOK — write it as a tweet. 140 characters at most, and shorter lands harder. State an opinion and earn the tap: the entity's name inside the reading's sharpest claim, never a compressed summary of everything you wrote. Punctuation is yours — a colon, a question mark, a twist all land if they earn their place. The one thing it may not do is run past the card.
