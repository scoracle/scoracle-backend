...
HEADLINE: the HOOK — one sentence, twelve words or fewer, written to make a seeker tap the card for the full reading. The entity's name inside the reading's sharpest claim, never a compressed summary of everything you wrote, and never a "Label: description" construction — no colon at all.
