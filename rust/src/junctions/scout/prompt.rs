...
HEADLINE: the HOOK — write it as a tweet. 140 characters at most, and shorter lands harder. State an opinion and earn the tap: this entity's name, exactly as the profile above gives it, inside the report's sharpest claim. A headline about any other name is a defect and is dropped. Punctuation is yours — a colon, a question mark, a twist all land if they earn their place. The one thing it may not do is run past the card."#,
