...
--
-- The 033 title-proximity gate (abs(te.title_pos - pe.title_pos) <= 50) is RETAINED here —
-- it retires together with the fuzzy matcher in task 5, once the scrub is the sole
-- precision pass. This migration only ADDS the vetted filter alongside it.

BEGIN;

-- ---------------------------------------------------------------------------
-- compute_transfer_heat — now reads the vetted news corpus (proximity gate kept).
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- seed_transfer_rumors — candidate discovery on the vetted corpus (proximity kept).
-- ---------------------------------------------------------------------------
