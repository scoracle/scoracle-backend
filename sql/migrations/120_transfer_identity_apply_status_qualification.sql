-- 120_transfer_identity_apply_status_qualification.sql
--
-- Fix apply_transfer_identity_candidate() idempotency lookup after Phase 1.
-- The function returns a column named "status"; inside PL/pgSQL, an unqualified
-- table column named status is ambiguous with that return variable.
...
VALUES ('120_transfer_identity_apply_status_qualification')
