-- Scoracle Stats Database - Sport-Specific Schema
-- Version: 4.0
-- Created: 2026-01-16
-- Purpose: Sport-specific profile tables to eliminate cross-sport data pollution
--
-- Key changes from v3.0:
-- - Split unified `players` table into nba_player_profiles, nfl_player_profiles, football_player_profiles
-- - Split unified `teams` table into nba_team_profiles, nfl_team_profiles, football_team_profiles
-- - Stats tables now reference sport-specific profile tables
-- - Football profiles include league_id for multi-league support

-- ============================================================================
-- CORE TABLES (Unified - no changes)
-- ============================================================================
...
-- NBA Team Profiles (must be created before players for FK)
...
CREATE INDEX IF NOT EXISTS idx_nba_team_profiles_name ON nba_team_profiles(name);
CREATE INDEX IF NOT EXISTS idx_nba_team_profiles_conference ON nba_team_profiles(conference, division);
CREATE INDEX IF NOT EXISTS idx_nba_team_profiles_needs_fetch ON nba_team_profiles(id) WHERE profile_fetched_at IS NULL;
...
CREATE TABLE IF NOT EXISTS nba_player_profiles (
    ...
    weight_lbs INTEGER,
    photo_url TEXT,
    current_team_id INTEGER REFERENCES nba_team_profiles(id),
...
CREATE INDEX IF NOT EXISTS idx_nba_player_profiles_team ON nba_player_profiles(current_team_id);
CREATE INDEX IF NOT EXISTS idx_nba_player_profiles_name ON nba_player_profiles(full_name);
CREATE INDEX IF NOT EXISTS idx_nba_player_profiles_position ON nba_player_profiles(position_group);
CREATE INDEX IF NOT EXISTS idx_nba_player_profiles_needs_fetch ON nba_player_profiles(id) WHERE profile_fetched_at IS NULL;
CREATE INDEX IF NOT EXISTS idx_nba_player_profiles_active ON nba_player_profiles(is_active) WHERE is_active = true;
...
CREATE INDEX IF NOT EXISTS idx_nfl_team_profiles_name ON nfl_team_profiles(name);
CREATE INDEX IF NOT EXISTS idx_nfl_team_profiles_conference ON nfl_team_profiles(conference, division);
CREATE INDEX IF NOT EXISTS idx_nfl_team_profiles_needs_fetch ON nfl_team_profiles(id) WHERE profile_fetched_at IS NULL;
...
CREATE TABLE IF NOT EXISTS nfl_player_profiles (
    ...
    weight_lbs INTEGER,
    photo_url TEXT,
    current_team_id INTEGER REFERENCES nfl_team_profiles(id),
    jersey_number INTEGER,
    college TEXT,
    experience_years INTEGER,
    profile_fetched_at TIMESTAMPTZ,
...
CREATE INDEX IF NOT EXISTS idx_nfl_player_profiles_team ON nfl_player_profiles(current_team_id);
CREATE INDEX IF NOT EXISTS idx_nfl_player_profiles_name ON nfl_player_profiles(full_name);
CREATE INDEX IF NOT EXISTS idx_nfl_player_profiles_position ON nfl_player_profiles(position_group);
CREATE INDEX IF NOT EXISTS idx_nfl_player_profiles_needs_fetch ON nfl_player_profiles(id) WHERE profile_fetched_at IS NULL;
CREATE INDEX IF NOT EXISTS idx_nfl_player_profiles_active ON nfl_player_profiles(is_active) WHERE is_active = true;

-- ============================================================================
-- FOOTBALL (SOCCER) PROFILE TABLES - With league_id support
-- ============================================================================
...
CREATE INDEX IF NOT EXISTS idx_football_team_profiles_name ON football_team_profiles(name);
CREATE INDEX IF NOT EXISTS idx_football_team_profiles_league ON football_team_profiles(league_id);
CREATE INDEX IF NOT EXISTS idx_football_team_profiles_country ON football_team_profiles(country);
CREATE INDEX IF NOT EXISTS idx_football_team_profiles_needs_fetch ON football_team_profiles(id) WHERE profile_fetched_at IS NULL;

-- Football Player Profiles (includes league_id per requirement)
CREATE TABLE IF NOT EXISTS football_player_profiles (
    ...
    weight_lbs INTEGER,
    photo_url TEXT,
    current_team_id INTEGER REFERENCES football_team_profiles(id),
...
CREATE INDEX IF NOT EXISTS idx_football_player_profiles_team ON football_player_profiles(current_team_id);
CREATE INDEX IF NOT EXISTS idx_football_player_profiles_league ON football_player_profiles(current_league_id);
CREATE INDEX IF NOT EXISTS idx_football_player_profiles_name ON football_player_profiles(full_name);
CREATE INDEX IF NOT EXISTS idx_football_player_profiles_position ON football_player_profiles(position_group);
CREATE INDEX IF NOT EXISTS idx_football_player_profiles_needs_fetch ON football_player_profiles(id) WHERE profile_fetched_at IS NULL;
CREATE INDEX IF NOT EXISTS idx_football_player_profiles_active ON football_player_profiles(is_active) WHERE is_active = true;
CREATE INDEX IF NOT EXISTS idx_football_player_profiles_league_position ON football_player_profiles(current_league_id, position_group);
