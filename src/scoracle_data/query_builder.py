...
FOOTBALL_PLAYER_STATS_COLUMNS = [
    ...
    "rating", "is_captain", "subs_in", "subs_out",
    "goals", "assists", "goals_assists", "goals_per_90", "assists_per_90",
    "shots_total", "shots_on_target", "shot_accuracy",
    "shots_per_90", "goals_per_shot", "goals_per_shot_on_target",
    "passes_total", "passes_accurate", "pass_accuracy",
    "passes_per_90", "key_passes", "key_passes_per_90",
    "dribbles_attempted", "dribbles_successful", "dribble_success_rate", "dribbles_per_90",
    "duels_total", "duels_won", "duel_success_rate",
    "tackles", "tackles_per_90", "interceptions", "interceptions_per_90", "blocks",
    "fouls_committed", "fouls_drawn",
    "yellow_cards", "red_cards", "second_yellow_cards",
    "penalties_won", "penalties_scored", "penalties_missed", "penalties_conceded",
    "saves", "save_percentage", "goals_conceded", "goals_conceded_per_90",
    "updated_at",
]
