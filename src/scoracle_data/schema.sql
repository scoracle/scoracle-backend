-- Scoracle Data — Consolidated Schema v6.0
-- Updated: 2026-02-12
--
-- Single-file schema representing the complete database state.
-- Replaces the previous 8 incremental migration files (000-007).
--
-- Design principles:
...
--
-- Usage:
--   Run via schema.py init_database() for fresh Neon database setup.
--   Existing databases already have this schema applied via prior migrations.
